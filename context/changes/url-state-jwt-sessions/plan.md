...
- [ ] 1.2 Full e2e suite passes with 0 skipped: `uv run pytest tests/e2e -q`
- [ ] 1.3 New JWT URL-state tests green (restore, back/forward, desync, post-logout)
- [ ] 1.4 `static/*.html` == `index.html` only; no code references to removed files
