...
- [x] 4.1 `node --check` na inline JS przechodzi — 090746f
- [x] 4.2 Testy e2e importu przechodzą — 090746f
- [x] 4.3 Pełny pakiet zielony — 090746f
- [x] 4.4 Testy potwierdzają ukrycie przycisku importu w trybie „Wszystkie" — 090746f

#### Manual

- [x] 4.5 Import Głównego pokazuje 12 pozycji, CBF 188,40, S2B wśród pominiętych — 090746f
- [x] 4.6 Treemapa, kalendarz i wykres pokazują dane po imporcie bez odświeżania — 090746f
...
- [x] 4.7 Escape i klik poza modalem zamykają okno, brak błędów w konsoli — 090746f
- [x] 4.8 Motyw jasny i ciemny wyglądają poprawnie — 090746f
