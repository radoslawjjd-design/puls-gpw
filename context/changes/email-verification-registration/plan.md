...
- [x] 3.1 Full suite green: `uv run pytest --tb=short` — cacf89b
- [x] 3.2 Lint passes: `uv run ruff check .` — cacf89b

#### Manual

- [x] 3.3 Browser walkthrough: register confirmation, 403 state + resend, post-click login to dashboard — cacf89b
- [x] 3.4 Resend button UX (in-flight disable, 429 copy) — cacf89b
