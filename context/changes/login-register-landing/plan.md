...
- [x] 2.1 Unit tests pass: `uv run pytest tests/ --ignore=tests/e2e -q` — 02da22d
- [x] 2.2 Full e2e suite green after helper updates: `uv run pytest tests/e2e -q` — 02da22d

#### Manual

- [x] 2.3 Local visual check: landing light/dark/mobile, cards, tabs, API-key path to dashboard — 02da22d
