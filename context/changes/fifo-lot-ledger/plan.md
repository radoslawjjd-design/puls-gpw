...
short throwaway script run against the current code; only the artefacts are committed.
They are what criteria 2.6 and 3.6 diff against, and they are deleted at archive.
