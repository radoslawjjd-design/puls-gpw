...
- [x] 3.1 Existing test suite still passes: `uv run pytest tests/ --ignore=tests/e2e` — 4cb78fb

#### Manual

- [x] 3.2 All 7 columns populated with real data, newest first — 4cb78fb
- [x] 3.3 Each filter narrows results correctly against live data — 4cb78fb
- [x] 3.4 Page-size select and Prev/Next page correctly; disabled states correct — 4cb78fb
- [x] 3.5 Changing page size resets to page 1 — 4cb78fb
- [x] 3.6 No `/admin/x-posts` request fires before the menu item is clicked — 4cb78fb

### Phase 4: Frontend — tweet-thread popup

#### Automated

- [x] 4.1 Existing test suite still passes: `uv run pytest tests/ --ignore=tests/e2e` — b228f21

#### Manual

- [x] 4.2 Published row popup shows numbered tweets with working X links — b228f21
- [x] 4.3 Partial row popup shows links only for tweets that have an id — b228f21
- [x] 4.4 Failed/empty row popup shows "Brak treści" fallback — b228f21
- [x] 4.5 Modal close behaviors (✕, overlay click, Escape) unchanged for announcement rows — b228f21

### Phase 5: E2E coverage

#### Automated

- [x] 5.1 New E2E suite passes: `uv run pytest tests/e2e/test_x_post_history.py` — f3ad3ea
- [x] 5.2 Full E2E suite still green: `uv run pytest tests/e2e/` — f3ad3ea

#### Manual

- [x] 5.3 Re-run Phase 2-4 manual checks once more after E2E fixtures land — f3ad3ea
