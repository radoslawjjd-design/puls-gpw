...
- [ ] 3.1 `uv run pytest tests/ --tb=short` passes
- [ ] 3.2 E2E test `test_autocomplete.py` passes

#### Manual

- [ ] 3.3 Ticker field shows datalist suggestions from BQ
- [ ] 3.4 Company field shows datalist suggestions from BQ
- [ ] 3.5 Event type field shows 5 Polish labels; selection submits correct API code

### Phase 4: Visual Polish

#### Automated

- [ ] 4.1 `uv run pytest tests/e2e/ --tb=short` passes — no regressions
