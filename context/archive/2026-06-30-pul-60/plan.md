...
- [x] 3.1 pytest tests/ przechodzą — e91e885

#### Manual

- [x] 3.2 2. wywołanie Treemap w ciągu 60 s — X-Process-Time < 50 ms — e91e885
- [x] 3.3 Po 70 s: 3. wywołanie znów > 300 ms (TTL wygasł) — e91e885
